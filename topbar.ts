...
import { Button, BoxLayout } from "./@types/Gjs/St-1.0";
...
import { Tweener, Signals } from "./utils";
...
function createButton(icon_name: string, accessible_name: string) {
...
const PopupMenuEntryHelper = function constructor(text: any) {
...
class Color {
  ...
  constructor(color: string, container: any) {
...
const WorkspaceMenu = Utils.registerClass(
...
let menu;
let orginalActivitiesText: any;
let screenSignals: any[], signals: Signals;
function init() {
...
let panelBoxShowId, panelBoxHideId;
function enable() {
