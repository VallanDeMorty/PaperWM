...
const Tweener = Extension.imports.utils.tweener;
...
const Me = Extension.imports.tiling;
...
const stack_margin = 75;
// Minimum margin
const minimumMargin = () => Math.min(15, prefs.horizontal_margin);
...
const PreviewMode = { NONE: 0, STACK: 1, SEQUENTIAL: 2 };
const inPreview = PreviewMode.NONE;
...
const focus_wrapper = utils.dynamic_function_ref("focus_handler", Me);
...
const minimizeWrapper = utils.dynamic_function_ref("minimizeHandler", Me);
...
const showWrapper = utils.dynamic_function_ref("showHandler", Me);
